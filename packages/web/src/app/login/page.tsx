...
export default function LoginPage() {
    ...
    const getCallbackUrl = () => {
        if (isExtension) {
            return "/auth-callback?extension=true";
        }
        return "/dashboard";
    };
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-gray-50">
            <div className="w-full max-w-md">
                ...
                <Link
                    href="/"
                    className="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 transition mb-8"
                >
                ...
                {isExtension && (
                    <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-xl text-center">
                        <p className="text-sm text-blue-700">
                            🔌 Đăng nhập từ <strong>LinkedBoost Extension</strong>
                        </p>
                    </div>
                )}
                ...
                <div className="card">
                    ...
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center gap-2 mb-4">
                            ...
                            <span className="text-2xl font-bold font-heading text-gray-900">LinkedBoost AI</span>
                        </div>
                    ...
                    <div className="space-y-4">
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                        >
                            {isLoading === "google" ? (
                        ...
                        <button
                            ...
                            disabled={isLoading !== null}
                            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-[#0077B5] hover:bg-[#006699] text-white font-medium rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                        >
                            {isLoading === "linkedin" ? (
                                <Loader2 className="w-5 h-5 animate-spin" />
                            ) : (
                    ...
                    <ul className="space-y-3 text-sm text-gray-600">
                        ...
                        <li className="flex items-center gap-3">
                            ...
                            1 lần phân tích profile mỗi tháng
                        </li>
                        <li className="flex items-center gap-3">
                            <span className="w-5 h-5 rounded-full bg-green-100 text-green-600 flex items-center justify-center">
                                <Check className="w-3 h-3" />
